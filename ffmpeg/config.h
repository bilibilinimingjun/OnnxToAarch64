...
#define FFMPEG_CONFIGURATION "--enable-shared --disable-x86asm --prefix=/usr/local/opt/ffmpeg --disable-static"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/usr/local/opt/ffmpeg/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/opt/ffmpeg/share/ffmpeg"
